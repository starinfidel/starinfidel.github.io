...
//  window.alert('c:' + e.charCode + ' k:' + e.keyCode);
  ...
  // down
  else if (keyCode == 40 || keyCode == 50 || keyCode == 98)
    y++;

  // left
  else if (keyCode == 37 || keyCode == 52 || keyCode == 100)
    x--;

  // right
  else if (keyCode == 39 || keyCode == 54 || keyCode == 102)
    x++;

  // ul
  else if (keyCode == 36 || keyCode == 55 || keyCode == 103)
    {
      x--;
      y--;
    }
  ...
  // ur
  else if (keyCode == 33 || keyCode == 57 || keyCode == 105)
    {
      x++;
      y--;
    }
  ...
  // dl
  else if (keyCode == 35 || keyCode == 49 || keyCode == 97)
    {
      x--;
      y++;
    }
  ...
  // dr
  else if (keyCode == 34 || keyCode == 51 || keyCode == 99)
    {
      x++;
      y++;
    }
