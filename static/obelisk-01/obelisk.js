...
UI.prototype.paintStatus = function() {
	var s = (((((((((("<table width=100%><tr><td halign=left>Obelisks found: " + this.game.map.obelisksFound()) + " / ") + this.game.map.obelisks.length) + "<td halign=left>Obelisks shattered: ") + this.game.map.obelisksShattered()) + " / ") + this.game.map.obelisks.length) + "<td halign=right><p style='text-align:right; margin-right:5'>") + "Turns: ") + this.game.turns) + "</table>";
...
Map.prototype.obelisksFound = function() {
	var cnt = 0;
	{ var $it4 = this.game.map.obelisks.iterator();
	while( $it4.hasNext() ) { var o = $it4.next();
	if(o.isVisible) cnt++;
	}}
	return cnt;
}
...
Map.prototype.revealCloseObelisks = function(cell) {
	...
	{ var $it6 = this.obelisks.iterator();
